...
(3, 'HP Spectre x360', 'hp_avatar.png', 'Spectre2021', 150, 'Black', true, '2022-03-01', 3, 3, 1, 1, 1),
...
(3, 'Samsung SSD 1TB', 'ssd_avatar.png', 'Samsung 1TB SSD', 5, 'Black', '2022-03-01', 3, 3, 3, 3, 3, 3),
(4, 'Corsair RAM 16GB', 'ram_avatar.png', 'Corsair 16GB RAM', 10, 'Black', '2022-04-01', 4, 4, 4, 4, 4, 4),
(5, 'Intel i9 CPU', 'cpu_i9_avatar.png', '10th Gen Intel Core i9', 65, 'Silver', '2022-05-01', 5, 5, 5, 5, 5, 5),
...
(10, 'Crucial SSD 500GB', 'ssd_crucial_avatar.png', 'Crucial 500GB SSD', 5, 'Black', '2022-10-01', 8, 3, 3, 3, 3, 3),
(11, 'Intel i5 CPU', 'cpu_i5_avatar.png', '9th Gen Intel Core i5', 65, 'Silver', '2022-11-01', 9, 4, 4, 4, 4, 4),
(12, 'AMD Radeon RX 580', 'radeon_avatar.png', 'AMD Radeon RX 580', 185, 'Black', '2022-12-01', 10, 5, 5, 5, 5, 5),
...
(15, 'Asus Motherboard', 'motherboard_avatar.png', 'Asus ROG Strix B450-F', 50, 'Black', '2023-03-01', NULL, 3, 3, 3, 3, 3);
...
(11, 'Perfect for my needs, no compatibility problems.', 10, 11, 6, NULL),
(12, 'Could be better, some compatibility issues.', 6, 12, NULL, 6),
(13, 'Fantastic performance, fully compatible.', 9, 13, 7, NULL),
(14, 'Very satisfied with the compatibility.', 8, 14, NULL, 7),
(15, 'Would use again, no compatibility issues.', 9, 15, 8, NULL);
